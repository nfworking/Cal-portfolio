...
const Hero = () => {
  return (
    <section>
      <div className="relative z-10 min-h-screen flex flex-wrap flex-col md:flex-row items-center jusitfy-center text-white">
        <motion.div
        ...
        <motion.div
            className="w-full mt-20 md:w-1/2 p-8"
            initial="hidden"
            animate="visible"
